...
if (!defined('SITE_URL')) {
    ...
    $is_ip_access = filter_var($host, FILTER_VALIDATE_IP);
    $basePath = $is_ip_access ? '/' : '/mosseluxe/';
...
if (!defined('YOCO_MODE')) define('YOCO_MODE', getenv('YOCO_MODE') ?: 'sandbox');
...
// Shipping Cost
if (!defined('SHIPPING_COST')) define('SHIPPING_COST', 100.00);
