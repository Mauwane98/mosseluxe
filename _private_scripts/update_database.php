...
// Assuming this script is run from the project root, let's use the main bootstrap.
...
$sample_pages = [
    [
        ...
        'slug' => 'terms-of-service', // This matches the slug in the old seed_pages.php
...
<p>If you have any questions about these terms, please contact us through our contact form.</p>',
    ...
    [
        ...
        'slug' => 'privacy-policy', // This matches the slug in the old seed_pages.php
...
<p>If you have any questions about this privacy policy, please contact us through our contact form.</p>',
    ...
    [
        ...
        'slug' => 'shipping-returns', // This matches the slug in the old seed_pages.php
...
<p>If you have any questions about shipping or returns, please contact us through our contact form.</p>',
    ...
    [
        'title' => 'About Us',
        'slug' => 'about',
        'content' => '<h2>The Inspiration: Moses Rapudi Mauwane</h2>
...
<h2>Our Name</h2>
<p>“Mossé” to honor the man who started it all. “Luxe” for a luxury defined by quality, not price.</p>
<p><strong>Luxury Inspired by Legacy</strong></p>

<h2>Our Commitment</h2>
<p>From our beginnings in leather goods to our expansion into apparel, three principles guide every stitch and every cut.</p>
<ul>
    <li><strong>Heritage:</strong> We ensure the story of skill and determination lives on in every piece we create.</li>
    <li><strong>Craftsmanship:</strong> Our commitment to quality is unwavering, with an intense focus on detail and care.</li>
    <li><strong>Modern Style:</strong> We blend our rich history with timeless design for a new generation of luxury.</li>
</ul>',
        'status' => 1
    ],
    [
...
<p>Be part of the Mossé Luxe family and help shape the future of luxury streetwear.</p>

<h3>Why Work at Mossé Luxe?</h3>
<p>At Mossé Luxe, we believe in creating a workplace that reflects our values of heritage, craftsmanship, and modern style. We\'re passionate about quality and innovation, and we want team members who share that passion.</p>

<h3>Current Openings</h3>
<p>We don\'t have any open positions at the moment, but we\'re always interested in hearing from talented individuals. Send us your resume and tell us why you\'d like to join our team.</p>

<h3>How to Apply</h3>
<p>If you\'re interested in joining Mossé Luxe, please send your resume and a brief cover letter to <a href="mailto:careers@mosseluxe.com">careers@mosseluxe.com</a>. We\'ll keep your information on file for future opportunities.</p>

<h3>Our Culture</h3>
<p>We foster a collaborative and creative environment where every team member has the opportunity to contribute to our brand\'s success. We value diversity, creativity, and a commitment to excellence.</p>',
        'status' => 1
    ],
    [
        'title' => 'Frequently Asked Questions',
        'slug' => 'faq',
        'content' => '<h3>What are your shipping options?</h3>
...
<p>Once your order has been shipped, you will receive an email with a tracking number and a link to the courier\'s website. You can also use our <a href="/track-order">Track Order</a> page to check the status.</p>

<h3>What is your return policy?</h3>
<p>We accept returns within 30 days of purchase for items that are unworn, unwashed, and in their original condition with all tags attached. Please visit our <a href="/shipping-returns">Shipping & Returns</a> page for more detailed information on how to initiate a return.</p>',
        'status' => 1
    ]
];
